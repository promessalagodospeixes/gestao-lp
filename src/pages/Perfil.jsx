  ...
  return (
    <div style={{ maxWidth: 480 }}>
      ...
      <div style={{ background:'var(--s1)', border:'1px solid var(--bd)', borderRadius:10, padding:'18px 16px' }}>
        <div style={{ fontWeight:700, fontSize:13, color:'var(--cy)', letterSpacing:'-.01em', marginBottom:14 }}>Nome de exibição</div>
        <FormGrid>
          <FG full>
        ...
        <div style={{ fontWeight:700, fontSize:13, color:'var(--cy)', letterSpacing:'-.01em', margin:'18px 0 14px' }}>Dados de contato</div>
        <FormGrid>
        ...
        <div style={{ fontWeight:700, fontSize:13, color:'var(--cy)', letterSpacing:'-.01em', margin:'18px 0 14px' }}>Alterar senha</div>
        ...
        <div style={{ marginTop:14 }}>
          <Btn onClick={salvar} disabled={saving}>{saving ? 'Salvando...' : <><Save size={15}/> Salvar Alterações</>}</Btn>
        </div>
      </div>

      {/* Termos aceitos */}
      <div style={{ background:'var(--s1)', border:'1px solid var(--bd)', borderRadius:10, padding:'18px 16px', marginTop:16 }}>
        <div style={{ fontWeight:700, fontSize:13, color:'var(--cy)', letterSpacing:'-.01em', marginBottom:12 }}>Aviso de privacidade aceito</div>
        {user?.lgpd_aceito
          ? <>
